...
const EditPythiaPage = ({ page }) => {
  ...
  return (
    // prettier-ignore
    <PageWrapper {...page} title="Pythia" layout={pattern ? WorkbenchLayout : false} header={null}>
      {pattern ? (
        <EditDesignComponent
          id={pattern.id}
