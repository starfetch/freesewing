...
export default {
  ...
  options: {
    ...
    barrelCuffNarrowButton: { bool: false },
    seperateButtonPlacket: { bool: true },
    seperateButtonholePlacket: { bool: true },
    ...
    sleevePlacketWidth: { pct: 0, min: 0, max: 18 },
    ...
    bicepsEase: { pct: 14.9, min: -10, max: 35 },
    buttonFreeLength: { pct: 2, min: 0, max: 15 },
    chestEase: { pct: 13.9, min: -10, max: 35 },
    collarBend: { pct: 5, min: 0, max: 10 },
    collarEase: { pct: 10, min: -10, max: 10 },
    collarGap: { pct: 3, min: 0, max: 6 },
    collarRoll: { pct: 3, min: 0, max: 6 },
    cuffDrape: { pct: 0, min: 0, max: 10 },
    cuffEase: { pct: -10, min: -10, max: 40 },
    cuffLength: { pct: 0, min: 0, max: 15 },
    frontArmholeDeeper: { pct: 1.4, min: 0, max: 1.5 },
    hemCurve: { pct: 50, min: 25, max: 100 },
    hipsEase: { pct: -1.2, min: -10, max: 35 },
    lengthBonus: { pct: 0.8, min: -4, max: 60 },
    roundBack: { pct: 0, min: 0, max: 10 },
    shoulderEase: { pct: 2, min: -10, max: 15 },
    ...
    sleevePlacketLength: { pct: 0, min: 0, max: 35 },
    waistEase: { pct: -8.2, min: -15, max: 35 },
